Feature: User able to view the Transaction Report

    Background: Successfully log into WebGains app with valid credentials
        ...
        Scenario: Verify user able to view Transaction Report with specific date range
            ...
            And the user click on the Transaction Report sub-navigation menu
            And the user should be redirected to the Transaction Report page
            When the user set the expected date range to view the report
            And the user click on apply button
            Then the user should see the transaction report for the specified date range
